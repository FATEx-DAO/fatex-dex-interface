...
export const FATE_REWARD_CONTROLLER: { [chainId in ChainId]: string } = {
  ...
  [ChainId.HARMONY_TESTNET]: '0x1c75b19951373bC6481ff59A5820D79206fA6E60'
}
...
export const GITBOOK_HELP_LINK = 'https://fatexdao.gitbook.io/fatexdao/tokenomics/rewards-locking-1'
