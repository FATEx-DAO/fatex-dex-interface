...
export const ROUTER_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.HARMONY_MAINNET]: '0x4a89c4786F7043907d8a8fCFE90b9Fd64C9317c7',
  [ChainId.HARMONY_TESTNET]: '0x4a89c4786F7043907d8a8fCFE90b9Fd64C9317c7'
}
...
export const GOVERNANCE_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.BSC_MAINNET]: ZERO_ONE_ADDRESS,
  [ChainId.BSC_TESTNET]: ZERO_ONE_ADDRESS,
  [ChainId.HARMONY_MAINNET]: '0x64C59aa83a2E3bEb8C7ffAEf9a6Ca2523d865233',
  [ChainId.HARMONY_TESTNET]: '0x64C59aa83a2E3bEb8C7ffAEf9a6Ca2523d865233'
}
...
export const TIMELOCK_ADDRESS = {
  ...
  [ChainId.BSC_MAINNET]: ZERO_ONE_ADDRESS,
  [ChainId.BSC_TESTNET]: ZERO_ONE_ADDRESS,
  [ChainId.HARMONY_MAINNET]: '0x9d218543d4fd58218fE22767543425F42B5d4138',
  [ChainId.HARMONY_TESTNET]: '0x9d218543d4fd58218fE22767543425F42B5d4138'
}
...
export const FATE_REWARD_CONTROLLER: { [chainId in ChainId]: string } = {
  ...
  [ChainId.BSC_MAINNET]: ZERO_ONE_ADDRESS,
  [ChainId.BSC_TESTNET]: ZERO_ONE_ADDRESS,
  [ChainId.HARMONY_MAINNET]: '0x813a49E28b02ceCAd3Eb966AeFd112f648c2b2f3',
  [ChainId.HARMONY_TESTNET]: '0x813a49E28b02ceCAd3Eb966AeFd112f648c2b2f3'
}
...
export const FEE_TOKEN_CONVERTER: { [chainId in ChainId]: string } = {
  ...
  [ChainId.BSC_MAINNET]: ZERO_ONE_ADDRESS,
  [ChainId.BSC_TESTNET]: ZERO_ONE_ADDRESS,
  [ChainId.HARMONY_MAINNET]: '0x3d16a3a4116bCC1f6CAa5556B22C17b71fB3407F',
  [ChainId.HARMONY_TESTNET]: '0x3d16a3a4116bCC1f6CAa5556B22C17b71fB3407F'
}
...
export const SUSHI_MIGRATOR: { [chainId in ChainId]: string } = {
  ...
  [ChainId.BSC_MAINNET]: ZERO_ONE_ADDRESS,
  [ChainId.BSC_TESTNET]: ZERO_ONE_ADDRESS,
  [ChainId.HARMONY_MAINNET]: '0xceA2443DB9d480484d0bE7E71BB5CE9d92447087',
  [ChainId.HARMONY_TESTNET]: '0xceA2443DB9d480484d0bE7E71BB5CE9d92447087'
}
...
export const VIPER_MIGRATOR: { [chainId in ChainId]: string } = {
  ...
  [ChainId.BSC_MAINNET]: ZERO_ONE_ADDRESS,
  [ChainId.BSC_TESTNET]: ZERO_ONE_ADDRESS,
  [ChainId.HARMONY_MAINNET]: '0x3F294E60899947241A66C70caBaBbb3F7b2f6833',
  [ChainId.HARMONY_TESTNET]: '0x3F294E60899947241A66C70caBaBbb3F7b2f6833'
}
